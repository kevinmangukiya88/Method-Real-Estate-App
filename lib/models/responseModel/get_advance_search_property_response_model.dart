...
GetAdvanceSearchPropertyResponseModel
    getAdvanceSearchPropertyResponseModelFromJson(String str) =>
        GetAdvanceSearchPropertyResponseModel.fromJson(json.decode(str));

String getAdvanceSearchPropertyResponseModelToJson(
        GetAdvanceSearchPropertyResponseModel data) =>
    json.encode(data.toJson());

class GetAdvanceSearchPropertyResponseModel {
  ...
  factory GetAdvanceSearchPropertyResponseModel.fromJson(
