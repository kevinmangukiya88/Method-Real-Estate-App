class GetTransactionsContractsResponseModel {
  int? status;
  Data? data;

  GetTransactionsContractsResponseModel({this.status, this.data});

  GetTransactionsContractsResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
